...
UPDATE `script_texts` SET `content_loc3`='%s wird wahnsinnig!' WHERE (`entry`='-1000156');
###
# Missing entries -1 000 157 to -1 000 158
###
...
###
# Missing entries -1 000 208 to -1 000 217
###
...
###
# Missing entries -1 000 230 to -1 000 233
###
...
###
# Missing entries -1 000 256 to -1 000 263
###
...
###
# Missing entries -1 000 280 to -1 000 286
###
...
###
# Missing entrie -1 000 291  ??it exists??
###
...
###
# Missing entries -1 000 293 to -1 000 297
###
...
###
# Missing entries -1 000 306 to -1 000 322
###
...
UPDATE `script_texts` SET `content_loc3`='Ich habe so das Gefühl, dass s. Gesprungener Golem auch hinter diesem rätselhaften Fossil her ist. Hilfe!' WHERE (`entry`='-1000339');
###
# Missing entries -1 000 340 to -1 000 342
###
...
###
# Missing entries -1 000 348 to -1 000 369
###
...
###
# Missing entries -1 000 399 to -1 000 415
###
...
###
# Missing entries -1 000 452 to -1 000 476
###
...
###
# Missing entries -1 000 482 to -1 000 510
###
...
UPDATE `script_texts` SET `content_loc3`='%s atmet tief aus...' WHERE (`entry`='-1249004');
...
###
# Missing entries -1 329 000 to -1 329 003
###
...
###
# Missing entries -1 533 080 to -1 533 088
###
...
###
# Missing entries -1 533 090 and -1 533 091
###
...
###
# Missing entries -1 533 093 to -1 533 110
###
...
###
# Missing entries -1 533 113 to -1 533 115
###
UPDATE `script_texts` SET `content_loc3`='Euer Ende naht.' WHERE (`entry`='-1533116');
###
# Missing entries -1 533 117 to -1 533 119
###
...
###
# Missing entries -1 540 042 to -1 540 047
###
...
###
# Missing entries -1 564 097 to -1 564 129
###
...
###
# Missing entries -1 568 024 to -1 568 081
###
...
###
# Missing entries -1 574 005 to -1 574 020
###
...
###
# Missing entries -1 576 004 to -1 576 005
###
...
###
# Missing entries -1 602 000 to -1 602 042
###
...
###
# Missing entries -1 609 000 to -1 609 088
###
...
###
# Missing entries -1 615 004 to -1 615 007
###
...
###
# Missing entries -1 615 014 to -1 615 015
###
...
###
# Missing entries -1 615 021 to -1 615 023
###
...
###
# Missing entries -1 615 034 to -1 615 035
###
...
###
# Missing entries -1 615 038 to -1 615 040
###
